...
f.sender_key = ProtoField.bytes("fastd.sender_key", "Sender key")
f.recpt_key = ProtoField.bytes("fastd.recpt_key", "Recipient key")
f.sender_hskey = ProtoField.bytes("fastd.sender_hskey", "Sender Handshake key")
f.recpt_hskey = ProtoField.bytes("fastd.recpt_hskey", "Recipient Handshake key")
